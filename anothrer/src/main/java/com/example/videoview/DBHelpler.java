...
public class DBHelpler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_data (name, content) values('오승환', '돌직구 ???')");
        ...
        db.execSQL("insert into tb_drive (title, date, type) values ('하이브리드', '최종 수정 날짜 : 1월 16일 ', 'doc')");
        db.execSQL("insert into tb_drive (title, date, type) values ('이미지1', '최종 수정 날짜 : 1월 16일 ', 'img')");
